...
def test_review_point(capsys):     
    ...
    result_dictionary = CheckBudgets(Statics.__rp_3_9['entry'], 
    ...
    results_in_fault=0
    dictionary = result_dictionary.analyze_entity(Statics.__rp_3_9['entry'])   

    for item in dictionary[Statics.__rp_3_9['entry']]['findings']:
