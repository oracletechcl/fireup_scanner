...
def test_review_point(capsys):     
    ...
    result_dictionary = CompartmentWorkload(Statics.__rp_3_6['entry'], 
    ...
    results_in_fault=0
    dictionary = result_dictionary.analyze_entity(Statics.__rp_3_6['entry'])   

    for item in dictionary[Statics.__rp_3_6['entry']]['findings']:
        debug(item)
        results_in_fault += 1
