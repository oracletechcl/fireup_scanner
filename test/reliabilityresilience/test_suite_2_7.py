...
def test_review_point(capsys):     
    ...
    result_dictionary = RedundantConnections(Statics.__rp_2_7['entry'], 
    ...
    results_in_fault=0
    dictionary = result_dictionary.analyze_entity(Statics.__rp_2_7['entry'])   

    for item in dictionary[Statics.__rp_2_7['entry']]['findings']:
