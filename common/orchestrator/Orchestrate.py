...
from classes.reliabilityresilience.TEMP import TEMP
...
def __call_2_11(config, signer, report_directory):    
    ...
    __temp_dictionary = temp.analyze_entity(Statics.__rp_2_11['entry'])
    generate_on_screen_report(__temp_dictionary, report_directory, Statics.__rp_2_11['entry'])
    generate_mitigation_report(__temp_dictionary, report_directory, mitigation_report_name, Statics.__rp_2_11['fireup_items'])
